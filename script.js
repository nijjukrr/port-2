...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "interest in Artificial Intelligence & software dev.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
  "   Java, Data Structures & Algorithms, AI, Web Development",
  "#ffffff"
)}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
  "   Working on real-world projects that solve actual problems",
  "#ffffff"
)}

${this.wrapWithColor("⚡ Goal", "#ff8c00")}
${this.wrapWithColor(
  "   Continuously learn, improve, and build intelligent and",
  "#ffffff"
)}
${this.wrapWithColor(
  "   impactful solutions for the tech industry.",
  "#ffffff"
)}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Ready to learn, build, and innovate!",
      "#ffffff"
...
• ${this.wrapWithColor("Data Structures & Algorithms (DSA)", "#ffffff")}
• ${this.wrapWithColor("Artificial Intelligence (AI)", "#ffffff")}
• ${this.wrapWithColor("JavaScript / HTML / CSS", "#ffffff")}
• ${this.wrapWithColor("Web & Full-Stack Development", "#ffffff")}
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:nishanth.kr@example.com" style="color: #ffffff; text-decoration: none;">nishanth.kr@example.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://nijjukrr.github.io/port-2" target="_blank" style="color: #ffffff; text-decoration: none;">nijjukrr.github.io/port-2</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/nijjukrr" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/nijjukrr</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/nishanth-kr-6105a2380/" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/nishanth-kr-6105a2380</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
    ...
    this.projects = [
      {
        ...
        description: "An AI-powered gym and fitness assistant application to guide workouts and track fitness goals.",
        image: "image/projects/Screenshot 2026-04-12 145528.png",
        technologies: ["JavaScript", "HTML", "CSS", "MediaPipe"],
        demo: "https://ai-gym-fitness-assistant-psi.vercel.app",
        repo: "https://github.com/nijjukrr/-AI-Gym-Fitness-Assistant",
      },
      {
        title: "BOOK-TRIP",
        description: "An interactive, animated flight and trip booking web application.",
        image: "image/projects/Screenshot 2026-04-12 145546.png",
        technologies: ["JavaScript", "HTML", "CSS", "GSAP"],
        demo: "https://book-trip-animated.vercel.app",
        repo: "https://github.com/nijjukrr/BOOK-TRIP",
      },
      {
        title: "Business Manager",
        description: "A comprehensive dashboard for business owners to manage operations, sales, and analytics.",
        image: "image/projects/Screenshot 2026-04-12 145556.png",
        technologies: ["HTML", "CSS", "JavaScript"],
        demo: "https://buisness-manager-eight.vercel.app/",
        repo: "https://github.com/nijjukrr/buisness-manager",
      },
      {
        title: "Code Editor",
        description: "An online code editor that supports real-time editing, compiling, and execution of web languages.",
        image: "image/projects/Screenshot 2026-04-12 145615.png",
        technologies: ["React", "JavaScript", "HTML", "CSS"],
        demo: "https://code-editor-lhoz.vercel.app/",
        repo: "https://github.com/nijjukrr/CODE-EDITOR",
      },
      {
        title: "Coders Room",
        description: "A collaborative code editing environment for teams and remote peer-programming.",
        image: "image/projects/Screenshot 2026-04-12 145604.png",
        technologies: ["JavaScript", "Node.js", "Socket.io", "CSS"],
        demo: "https://codeers-room-collab.vercel.app/",
        repo: "https://github.com/nijjukrr/CODERS-ROOM",
      },
      {
        title: "Coursera 2.0",
        description: "A redesigned mock dashboard of the Coursera e-learning platform, optimized for student experiences.",
        image: "image/projects/Screenshot 2026-04-12 145628.png",
        technologies: ["HTML", "CSS", "JavaScript"],
        demo: "https://coursera-2-0.vercel.app/",
        repo: "https://github.com/nijjukrr/COURSERA-2.0",
      },
      {
        title: "Frontend LeetCode",
        description: "A clean frontend clone of LeetCode for practicing coding interview questions.",
        image: "image/projects/Screenshot 2026-04-12 145636.png",
        technologies: ["JavaScript", "HTML", "CSS"],
        demo: "https://frontend-leetcode-frontend-zeta.vercel.app",
        repo: "https://github.com/nijjukrr/frontend-leetcode",
      },
      {
        title: "Health Survey System",
        description: "An interactive health survey system designed for capturing student wellness analytics.",
        image: "image/projects/Screenshot 2026-04-12 145649.png",
        technologies: ["TypeScript", "React", "HTML", "CSS"],
        demo: "https://health-survey-system-iota.vercel.app/",
        repo: "https://github.com/nijjukrr/HEALTH-SURVEY-SYSTEM",
      },
      {
        title: "Mobile Website",
        description: "A mobile-responsive landing page showcase for retail and electronics stores.",
        image: "image/projects/Screenshot 2026-04-12 145716.png",
        technologies: ["HTML", "CSS", "JavaScript"],
        demo: "https://tirrupur-mobile.vercel.app",
        repo: "https://github.com/nijjukrr/MOBILE-WEBSITE",
      },
      {
        title: "Number Prediction Game",
        description: "An interactive number prediction game utilizing standard programming logic and state tracking.",
        image: "image/projects/Screenshot 2026-04-12 145724.png",
        technologies: ["HTML", "CSS", "JavaScript"],
        demo: "https://number-prediction-omega.vercel.app/",
        repo: "https://github.com/nijjukrr/number-prediction",
      },
      {
        title: "Python Online Quiz",
        description: "An online Python quiz application built with Streamlit for test taking and learning.",
        image: "image/projects/Screenshot 2026-04-12 145732.png",
        technologies: ["Python", "Streamlit", "JSON"],
        demo: "https://python-online---quiz-gn5cduewbvdov9ixtykgrh.streamlit.app/",
        repo: "https://github.com/nijjukrr/PYTHON-ONLINE---QUIZ",
      },
      {
        title: "Sentiment Analysis",
        description: "A machine learning based sentiment analyzer tool classifying text into positive, negative, and neutral.",
        image: "image/projects/Screenshot 2026-04-12 145741.png",
        technologies: ["Python", "Streamlit", "NLTK", "Machine Learning"],
        demo: "https://sentimental-analysis-99ofdsam4u93encmjigtkg.streamlit.app/",
        repo: "https://github.com/nijjukrr/SENTIMENTAL-ANALYSIS",
      }
    ];
  }
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "nishanth@kr: ~/interactive-resume";
...
╚═╝  ╚═══╝╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝   ╚═╝   ╚═╝  ╚═╝`;
    ...
    url.textContent = "nijjukrr.github.io/port-2";
